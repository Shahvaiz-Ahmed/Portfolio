            ...
            <div className="st-contact-info-wrap">
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Email</h4>
                  <Link to="shahvaiz123satti@gmail.com">shahvaiz123satti@gmail.com</Link>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
                ...
                <div className="st-single-info-details">
                  <h4>Phone</h4>
                  <span>+92 3223545701</span>
                  <span>+92 3155215889</span>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
                ...
                <div className="st-single-info-details">
                  <h4>Address</h4>
                  <span>Aziz Market Nilore, <br />Islamabad, Pakistan</span>
                </div>
              </div>
